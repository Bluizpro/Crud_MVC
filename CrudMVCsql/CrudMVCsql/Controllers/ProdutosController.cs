...
namespace CrudMVCsql.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,fabricante,categoria,quantidade,valor")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,fabricante,categoria,quantidade,valor")] Produto produto)
        {
            if (id != produto.Id)
            {
                return NotFound();
